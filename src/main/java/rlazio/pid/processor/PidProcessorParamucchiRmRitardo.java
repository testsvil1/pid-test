...
public class PidProcessorParamucchiRmRitardo implements PidProcessor {
	...
	public PidProcessorParamucchiRmRitardo(String siglaProvincia) {
	...
	public String[] getHeader() {
		return new String[] { "Nr Lavoratori Nazionali", "CF/P.IVA", "DENOMINAZIONE", "CCNL", "COMUNE SEDE LEGALE",
				...
				"Quota Riserva Disabili Nazionale", "Quota Riserva Art.18 Nazionale", "Scopertura Disabili Nazionale", "Scopertura Art.18 Nazionale","Codice Comunicazione", "Data Invio", "Tipo Comunicazione", "Codice Comunicazione Precedente" };
	}
