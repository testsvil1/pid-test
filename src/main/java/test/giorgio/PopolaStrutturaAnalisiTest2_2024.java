...
public class PopolaStrutturaAnalisiTest2_2024 {
	
	private static DateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");
	
	public static void main(String[] args) {
		long now = System.currentTimeMillis();
		// RICORDARSI DI AGGIORARE ANCHE L'ANNO DELLA DATA DI INVIO
...
//		System.out.println(accumulator.get("06263170489"));
		...
		for(String key: internalMap.keySet()){
			...
			try {
				dataCorrettoInvio = new SimpleDateFormat("dd/MM/yyyy").parse("01/02/2024");
